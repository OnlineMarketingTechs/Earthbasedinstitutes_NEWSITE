                  ...
                  <div className="inner-box">
                    <div className="image-box">
                      <img
                        ...
                        src="/assets/images/resource/image-34.jpg"
                        alt=""
                      />
                      <div className="icon-box">
                        ...
                        <h4>
                          Finance <br /> and Restructuring
                        </h4>
                      </div>
                      <div className="overlay">
                        <Link href="/finance-restructuring">
                    ...
                    <div className="content">
                      <div className="text">
                        Business will frequent occurs that have <br />{" "}
                        repudiated accepted cases.
                      </div>
                    </div>
                  </div>
                </div>
                <div className="col-lg-4 service-block-six">
                  <div className="inner-box">
                    <div className="image-box">
                      <img
                        className="lazy-image owl-lazy"
                        src="/assets/images/resource/image-35.jpg"
                        alt=""
                      />
                      <div className="icon-box">
                        <div className="icon">
                    ...
                    <div className="content">
                      <div className="text">
                        Obligations of business will frequently <br />
                        occurs pleasures accepted.
                      </div>
                    </div>
                  </div>
                </div>
                <div className="col-lg-4 service-block-six">
                  <div className="inner-box">
                    <div className="image-box">
                      <img
                        className="lazy-image owl-lazy"
                        src="/assets/images/resource/image-36.jpg"
                        alt=""
                      />
                      <div className="icon-box">
                        <div className="icon">
                        ...
                        <h4>
                          Trades <br /> and Stock Market
                        </h4>
                      </div>
                      <div className="overlay">
                        <Link href="/trades-stock-markets">
                          <span className="flaticon-right" />
                        </Link>
                      </div>
                    </div>
                    <div className="content">
                      <div className="text">
                        Master-builder of human happiness no <br /> one avoids
                        reject pleasure itself.
                      </div>
                    </div>
                  </div>
                </div>
                <div className="col-lg-4 service-block-six">
                  <div className="inner-box">
                    <div className="image-box">
                      <img
                        className="lazy-image owl-lazy"
                        src="/assets/images/resource/image-37.jpg"
                        alt=""
                      />
                      <div className="icon-box">
                        <div className="icon">
                ...
                <div className="col-lg-4 service-block-six">
                  <div className="inner-box">
                    <div className="image-box">
                      <img
                        className="lazy-image owl-lazy"
                        src="/assets/images/resource/image-38.jpg"
                        alt=""
                      />
                      <div className="icon-box">
                        <div className="icon">
                        ...
                        <h4>
                          Software <br /> and Research
                        </h4>
                      </div>
                      <div className="overlay">
                        <Link href="/software-research">
                          <span className="flaticon-right" />
                        </Link>
                      </div>
                    </div>
                ...
                <div className="col-lg-4 service-block-six">
                  <div className="inner-box">
                    <div className="image-box">
                      <img
                        className="lazy-image owl-lazy"
                        src="/assets/images/resource/image-39.jpg"
                        alt=""
                      />
                      <div className="icon-box">
                        <div className="icon">
