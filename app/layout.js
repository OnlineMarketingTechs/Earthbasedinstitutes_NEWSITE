...
export const metadata = {
  title: "Earth Base Instatute",
  description:
    "Earth Based Institute is dedicated to cultivating a more resilient, cooperative, and compassionate culture through earth-based healing, mindfulness, and Education.",
};
